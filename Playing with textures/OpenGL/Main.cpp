...
int main(void)
{
	...
	// Texture (for jpg use rgb instead of rgba)
	Texture WeedImage("FunnyOpenGL.png", GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
	WeedImage.texUnit(shaderProgram, "tex0", 0);
